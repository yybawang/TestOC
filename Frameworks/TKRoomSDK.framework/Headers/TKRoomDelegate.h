 ...
 */
- (void)roomManagerUserJoined:(NSString *)peerID inList:(BOOL)inList TK_Deprecated("Will did deprecated, please use '- (void)roomManagerUserJoined:inList:' '- (void)roomManagerRoomUserJoined:inList:'");
