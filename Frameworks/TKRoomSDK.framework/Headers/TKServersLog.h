 ...
 */
+ (int)setLogLevel:(TKLogLevel)level logPath:(NSString * _Nullable)logPath debugToConsole:(BOOL)debug __attribute__((deprecated("Will deprecated!!! Please use '+ (int)setLogInfo:(TKLogInfo *)logInfo' instead")));
